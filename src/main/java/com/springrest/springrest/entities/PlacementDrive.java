...
public class PlacementDrive
{
	...
	public PlacementDrive(int p_id, String c_name, String employment_type, String job_title, String job_description,
			...
			String requirement_remarks, String form_link, String form_deadline, String form_remarks) {
		super();
		this.p_id = p_id;
		this.c_name = c_name;
	...
	public String getForm_remarks() {
		return form_remarks;
	}


	public void setForm_remarks(String form_remarks) {
		this.form_remarks = form_remarks;
	}
